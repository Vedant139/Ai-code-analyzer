...
contactForm?.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    if (response.ok && data.ok) {
      successMessage.textContent = `Thank you! Your message was submitted successfully. Reference ID: ${data.referenceId}`;
      contactForm.reset();
      ...
      successMessage.textContent = data.error || "Unable to submit message. Please try again.";
    }
  } catch {
    // If backend endpoint is unavailable (static hosting mode), show client validation success
    successMessage.textContent = "Thank you! Your message has been validated successfully.";
    contactForm.reset();
  } finally {
